...
- ✅ **בחירת בדיקות לפי דרישה (UI)**  
  - אפשר לבחור כל דרישה בנפרד (1.1, 1.2, 2.3, 3.1 וכו’) במקום קבוצות כלליות.  
  - Tooltip לכל בדיקה עם תיאור קצר.
...
- ✅ **REQ 2.3 – שטח ממ"ד נטו**: חישוב שטח ממ"ד מתוך מידות פנימיות בתכנית 1:50 + הצגת ראיות (אורך/רוחב/שטח)
